...
type NifiStatus struct {
	// Represents the observations of a Nifi's current state.
	// Nifi.status.conditions.type are: "Available", "Progressing", and "Degraded"
	// Nifi.status.conditions.status are one of True, False, Unknown.
	// Nifi.status.conditions.reason the value should be a CamelCase string and producers of specific
	// condition types may define expected values and meanings for this field, and whether the values
	// are considered a guaranteed API.
	// Nifi.status.conditions.Message is a human readable message indicating details about the transition.
