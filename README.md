...
Apache NiFi Kubernetes Operator based on Operator framework SDK.
...
## Description
The NiFi Operator manages NiFi clusters deployed to Kubernetes 
and automates tasks related to operating a NiFi cluster. It provides 
a full management life-cycle for NiFi, including deployment, upgrades, 
